...
!!! tip "Welcome Back — 20 April 2026"
    This is the first session after the public holiday and term break. If you haven't already, ensure **Board 1 (Truck MCU)** is publishing sensor data over serial before today — you'll need it working for the MQTT publishing task.
    
    **Note:** Only Board 1 (the Truck MCU from Session 9) connects to AWS IoT Core. Board 2 (the Display MCU) stays local and receives data from Board 1 via serial or I²C.

Welcome to the AWS phase! This week you'll register your haul truck (Board 1) as an AWS IoT Thing, establish secure MQTT connectivity, and publish real sensor data to the cloud. You'll complete two AWS Skill Builder courses (1.5 hours total) and extend them with your Board 1 Pico W hardware.
...
- Generate and install X.509 certificates on Pico W (Board 1)
- Publish MQTT messages from Pico W to AWS IoT Core
...
**Navigation:** [← Week 9 (Electronics)](../electronics/09.md) | [Course Overview](../index.md) | [Week 11 →](11.md)
