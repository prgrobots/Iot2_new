...
!!! tip "Welcome Back — 20 April 2026"
    This is the first session after the public holiday and term break. If you haven't already, make sure your Pico W is publishing sensor data over serial before today — you'll need it working to complete the MQTT publishing task.

Welcome to the AWS phase! This week you'll register your haul truck as an AWS IoT Thing, establish secure MQTT connectivity, and publish real sensor data to the cloud. You'll complete two AWS Skill Builder courses (1.5 hours total) and extend them with your real Pico W hardware.
