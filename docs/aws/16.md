...
!!! info "Week 16 Build Activity"
    This AWS session runs **in parallel** with the pit station build. While completing these labs, you should also be working through the [Week 16 Pit Station Build guide](../capstone/pit-station.md) — that page covers the Pico W pit station device, LCD display, fleet MQTT subscriptions, and Week 16 deliverables. The fleet simulation concepts from these labs directly inform the pit station's multi-truck capability.
...
### Lab 6: Real-Time Cloud Processing
**Expected Duration:** 1–1.5 hours

**Concepts:**
- Cloud-based anomaly detection and alerting
- Real-time data aggregation and dashboards
- Immediate response to sensor anomalies

**Your Task:**
- Implement **cloud-based anomaly detection** using IoT Analytics:
  - Create real-time queries to detect vibration spikes
  - Send alerts to TwinMaker and dashboards when anomalies detected
  - Demonstrate cloud processing reducing latency to < 5 seconds
  - Show how cloud-based approach scales to 20+ trucks easily
---
...
1. **Shake the physical haul truck (Pico W)** to trigger vibration sensor
2. **Monitor MQTT:**
   ```bash
...
[← Week 15 (Industry Quest 1/3)](15.md) | [Course Overview](../index.md) | [Week 17 (Industry Quest 3/3) →](17.md)
