...
This week focuses on **edge computing** with AWS Greengrass for local data processing and **industrial protocol conversion**. You'll complete three SimuLearn labs on ETL at the edge, protocol conversion, and contextualizing industrial equipment data – all critical for mining operations with intermittent connectivity.
...
- Convert industrial protocols (Modbus simulation)
...
1. **SimuLearn Labs** – ETL, Protocols, Contextualization (3 labs)
2. **Greengrass Core Setup** – Edge device configuration
3. **Local Anomaly Detection** – Process vibration data at edge
4. **Protocol Simulation** – Modbus to MQTT gateway
...
!!! info "Required Completion"
    ...
    - SimuLearn: "Converting Industrial Protocols"
    - SimuLearn: "Contextualizing Industrial Equipment Data"
...
## SimuLearn Labs (Complete First)

### Lab 1: ETL at the Edge
**Focus:**
- Extract sensor data
- Transform/aggregate locally
- Load to cloud only when necessary

### Lab 2: Converting Industrial Protocols
**Focus:**
- Modbus TCP/RTU to MQTT
- OPC-UA integration
- Protocol gateway patterns

### Lab 3: Contextualizing Industrial Equipment Data
**Focus:**
- Asset hierarchy modeling
- Enriching raw sensor data with context
- Time-series data normalization

**Deliverable:** Screenshots of all 3 lab completions.
