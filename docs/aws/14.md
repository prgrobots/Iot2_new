...
This week focuses on **asset modeling and visualization** of IoT data using **AWS IoT SiteWise** for asset hierarchy and metrics, and **QuickSight** for creating interactive dashboards. Building on the real-time analytics foundation from Week 13, you'll model your haul trucks as industrial assets and create the pit station operator dashboard for fleet monitoring.
...
2. **SiteWise Asset Model** – Haul-Truck hierarchy and properties
3. **Data Ingestion** – Route analytics data to SiteWise
4. **QuickSight Dashboard** – Live fleet monitoring
5. **Capstone Preparation** – Ready industrial IoT for Weeks 15-18
...
!!! info "Required Completion"
    ...
    - Completed Week 13 cloud analytics pipeline
...
**Topics:**
- Real-time analytics with QuickSight, Timestream, and Grafana
- Industrial asset modeling best practices
- Visualization patterns for manufacturing dashboards
