...
This week focuses on **analytics and visualization** of IoT data using **AWS IoT SiteWise** for asset modeling, **IoT Analytics** for time-series processing, and **QuickSight** for dashboards. You'll complete the AWS Skill Builder course on analytics and visualization plus the free digital course on connecting systems to AWS for industrial manufacturing to create the pit station operator dashboard.
...
2. **Free Digital Course** – Connecting Systems and Machines to AWS for Industrial Manufacturing (45 min)
...
!!! info "Required Completion"
    ...
    - Free Digital Course: [Connecting Systems and Machines to AWS for Industrial Manufacturing](https://explore.skillbuilder.aws/) (45 min)

    - Truck publishing to AWS from Week 10-13
    - (Optional/Recommended) Try connecting a real ESP32 or Raspberry Pi Pico to AWS IoT Core using:
      - [ESP32 AWS IoT Example Repo (Arduino)](https://github.com/aws-samples/aws-iot-esp32-arduino-examples)
      - [AWS IoT Quick Connect Tutorial](https://docs.aws.amazon.com/iot/latest/developerguide/iot-quick-start.html)
    - These resources provide step-by-step instructions for real hardware connection, in addition to the simulated sensor (Python script) used in the course.
...
## AWS Skill Builder & Free Digital Course (Complete First)
...
### Course: Connecting Systems and Machines to AWS for Industrial Manufacturing (45 min)
**Topics:**
- Industrial system integration patterns
- SiteWise asset models
- OPC-UA connectivity

**Deliverable:** Screenshots of both course completions.
...
**Navigation:** [← Week 13](13.md) | [Course Overview](../overview.md) | [Week 15 (Industry Quest 1/3) →](15.md)
