...
> **Pico W — already in your hands:** The Raspberry Pi Pico W with soldered OLED and MPU6050 was introduced in **Session 5/6**. You've already run the I²C scanner, confirmed both devices at 0x3C and 0x68, and taken raw accelerometer readings. This session picks up from that point — you're not starting from scratch.

---

## Session Introduction

This session formalises and completes **Assessment 3** (Tire & Suspension Health Monitor) on the Raspberry Pi Pico W. You already have raw MPU6050 readings from Session 5/6. Now you'll add filtering algorithms to remove noise, build anomaly detection for predictive maintenance, and produce the full A3 submission. This work also bridges into AWS — clean, filtered sensor data is far more useful in the cloud than raw noisy readings.
...
!!! info "Required Reading"
    ...
    - Review your MPU6050 code from Session 5/6 (Pico W MicroPython)

!!! tip "Setup Check"
    - [ ] Raspberry Pi Pico W carrier board (OLED + MPU6050 soldered on)
    - [ ] Confirm I²C scanner still shows 0x3C (OLED) and 0x68 (MPU6050)
...
**Navigation:** [← Week 6/7](0607.md) | [Course Overview](../index.md) | [Week 9 →](09.md)
