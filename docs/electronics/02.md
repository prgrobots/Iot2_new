...
Your haul truck needs a **front panel RGB status indicator** visible from 50 meters away for live fleet status:
...
3. Short paragraph: "How will the RGB status system help fleet operators monitor truck conditions safely?"
...
**Navigation:** [← Week 1](01.md) | [Course Overview](../index.md) | [Week 3 →](03.md)
